...
export default function TrackerView({
  ...
  return (
    <div className="flex flex-col h-full bg-[#09090B] safe-top safe-bottom relative">
      ...
      {/* Botón finalizar */}
      <div className="absolute bottom-0 left-0 right-0 bg-[#09090B]/95 backdrop-blur-md border-t border-white/[0.05] p-4 z-20" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom) + 100px)' }}>
