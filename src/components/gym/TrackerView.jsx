...
>
  <button
    ...
    className="w-full bg-[#D4FF00] text-[#09090B] font-bold py-2.5 rounded-2xl text-sm transition-all active:scale-[0.98] shadow-lg shadow-[#D4FF00]/25 hover:bg-[#e5ff1a] hover:shadow-[0_0_30px_rgba(212,255,0,0.5)]"
  >
